...
> **Status — 2026-08-02.** All four P0s below are **fixed and verified**; `bun run qc` green (1051 mobile + 570 API tests). Migration `033_preserve_payroll_on_carer_deletion.sql` is **applied to the live Supabase project**. Everything from #5 onward is still open. See each P0 for what shipped and what was deliberately left.
