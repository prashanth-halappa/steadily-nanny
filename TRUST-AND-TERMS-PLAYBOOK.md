...
| A11 | Per-type audience map is TOTAL (missing entry fails typecheck) | PRESERVE | `notification.schema.ts:125-162` | preserve; extended (3-N: `cover_ask_reminder`→carer, `shift_no_show_digest`→parent; registry now 38) |
