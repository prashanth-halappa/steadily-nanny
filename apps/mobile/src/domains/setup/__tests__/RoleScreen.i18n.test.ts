...
describe('RoleScreen i18n', () => {
  it('localizes onboarding copy through auth namespace keys', () => {
    ...
    expect(screenSource).toContain("t('onboarding.role.inviteCode.title')");
    expect(screenSource).toContain(
      "t('onboarding.role.inviteCode.description')"
    );
    ...
    expect(screenSource).not.toContain('I have an invite code');
  });
});
