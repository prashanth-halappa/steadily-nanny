...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex flex-row h-10 native:h-12 items-center text-sm justify-between rounded-2xl border border-input bg-background px-4 py-3 web:ring-offset-background text-muted-foreground web:focus:outline-none web:focus:ring-2 web:focus:ring-ring web:focus:ring-offset-2 [&>span]:line-clamp-1',
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      className={cn(
        'relative web:group flex flex-row w-full web:cursor-default web:select-none items-center rounded-2xl py-3 native:py-3 pl-10 native:pl-12 pr-4 web:hover:bg-accent/50 active:bg-accent web:outline-none web:focus:bg-accent',
