...
function Menubar({
  ...
  return (
    <MenubarPrimitive.Root
      className={cn(
        'flex flex-row h-10 native:h-12 items-center space-x-1 rounded-3xl border border-border bg-background p-2',
        className
      )}
      {...props}
    />
...
function MenubarTrigger({
  ...
  return (
    <MenubarPrimitive.Trigger
      className={cn(
        'flex flex-row web:cursor-default web:select-none items-center rounded-2xl px-4 py-2 text-sm native:h-10 native:px-6 native:py-0 font-medium web:outline-none web:focus:bg-accent active:bg-accent web:focus:text-accent-foreground',
  ...
  return (
    <TextClassContext.Provider value="select-none text-sm native:text-lg text-popover-foreground web:group-focus:text-accent-foreground">
      <MenubarPrimitive.Item
        className={cn(
          'relative flex flex-row web:cursor-default items-center gap-2 rounded-2xl px-4 py-3 native:py-3 web:outline-none web:focus:bg-accent active:bg-accent web:hover:bg-accent group',
          inset && 'pl-8',
