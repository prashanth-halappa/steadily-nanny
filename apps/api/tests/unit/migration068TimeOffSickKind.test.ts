/**
 * @module tests/unit/migration068TimeOffSickKind.test
 * Pattern A — migration contract for `068_time_off_sick_kind.sql`, written
...
const MIGRATION = '068_time_off_sick_kind.sql';
...
describe('068 — adds carer_time_off.kind', () => {
  it('adds the column idempotently with a personal default', () => {
    // Every pre-068 row was a personal request; the default makes the
...
describe('068 — documentation contract', () => {
  for (const phrase of [
