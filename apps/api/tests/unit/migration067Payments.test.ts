/**
 * @module tests/unit/migration067Payments.test
 * Pattern A — migration contract for `067_payments.sql`, written BEFORE the
...
const MIGRATION = '067_payments.sql';
...
describe('067 — payments table shape', () => {
...
describe('067 — RLS: select-only, money-table read circle', () => {
  it('enables RLS', () => {
    expect(executable).toContain(
